...
def ecg_plot(
    ...
    # Uncomment to remove rythm strip
    #full_mode = 'None'
    ...
    # Set to False for standard layout
    use_cabrera = True 

    if columns == 1:
        leadNames_12 = (
            ['V6', 'V5', 'V4', 'V3', 'V2', 'V1', 'III', 'aVF', 'II', 'aVR', 'I', 'aVL']
            if use_cabrera else
            ['V6', 'V5', 'V4', 'V3', 'V2', 'V1', 'aVF', 'aVL', 'aVR', 'III', 'II', 'I']
        )
    elif columns == 2:
        leadNames_12 = (
            ['III', 'V6', 'aVF', 'V5', 'II', 'V4', 'aVR', 'V3', 'I', 'V2', 'aVL', 'V1']
            if use_cabrera else
            ['aVF', 'V6', 'aVL', 'V5', 'aVR', 'V4', 'III', 'V3', 'II', 'V2', 'I', 'V1']
        )
    elif columns == 3:
        leadNames_12 = (
            ['V4', 'V5', 'V6', 'V1', 'V2', 'V3', 'II', 'aVF', 'III', 'aVL', 'I', 'aVR']
            if use_cabrera else
            ['V4', 'V5', 'V6', 'V1', 'V2', 'V3', 'aVR', 'aVL', 'aVF', 'I', 'II', 'III']
        )
    elif columns == 4:
        leadNames_12 = (
            ['aVR', 'III', 'V3', 'V6', 'I', 'aVF', 'V2', 'V5', 'aVL', 'II', 'V1', 'V4']
            if use_cabrera else
